  ...
  render() {
    ...
    return (
      <div className="mx-auto max-w-3xl px-4 py-20">
        <div className="rounded-2xl border border-white/[0.12] bg-[#101E2F] p-6">
          ...
          <pre className="mt-4 overflow-auto whitespace-pre-wrap rounded-xl bg-black/5 p-4 text-xs text-[#F8FAFC]">

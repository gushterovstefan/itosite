export const solutionPages = {
  en: {
    ...
    'microsoft-azure': {
      ...
      icon: 'cloud',
      buyer: ['IT leaders planning cloud infrastructure', 'Teams replacing aging on-prem platforms', 'Businesses that need secure hosting with monitored availability and cost control'],
    ...
    'vmware-proxmox-virtualization': {
      ...
      lead: 'Reduce virtualization risk, licensing pressure and operational complexity across VMware or Proxmox environments.',
    ...
    'azure-hybrid-cloud': {
      ...
      lead: 'Extend on-prem VMware or Proxmox environments into Azure for disaster recovery, monitored hybrid operations and controlled migration.',
  ...
  bg: {
    ...
    'microsoft-azure': {
      ...
      icon: 'cloud',
      buyer: ['IT лидери, планиращи cloud infrastructure', 'Екипи, заменящи остарели on-prem platforms', 'Бизнеси с нужда от secure hosting, наблюдавана availability и cost control'],
    ...
    'microsoft-365': {
      ...
      subline: 'Teams, SharePoint и Exchange са по-сигурни, когато identity, devices и data rules са проектирани заедно.',
      icon: 'platform',
    ...
    'vmware-proxmox-virtualization': {
      ...
      eyebrow: 'Virtualization',
      lead: 'Намаляване на virtualization risk, licensing pressure и operational complexity във VMware или Proxmox среди.',
    ...
    'azure-hybrid-cloud': {
      ...
      eyebrow: 'Hybrid Cloud',
      lead: 'Разширяване на on-prem VMware или Proxmox към Azure за disaster recovery, наблюдавани hybrid operations и контролиран migration.',
